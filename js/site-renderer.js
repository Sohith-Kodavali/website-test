...
function renderIndex(D) {
  ...
  document.getElementById('render-craft-preview').innerHTML = '<section class="section craft-section"><div class="container"><div class="craft-hero reveal"><div class="craft-hero__visual reveal-slide-left"><div class="craft-img-card"><img src="5.jpeg" alt="Craft My Plate" loading="lazy" /><div class="craft-badge-pulse">Starting at <strong>₹250</strong> /person</div></div></div><div class="craft-hero__content reveal-slide-right"><span class="eyebrow">'+D.craftPreview.eyebrow+'</span><h2>'+D.craftPreview.headline+'</h2><p>'+D.craftPreview.desc+'</p><div class="craft-flow"><div class="craft-flow-item"><span class="craft-flow-num">1</span><span>Pick Your Menu</span></div><div class="craft-flow-arrow">→</div><div class="craft-flow-item"><span class="craft-flow-num">2</span><span>Set Guests &amp; Budget</span></div><div class="craft-flow-arrow">→</div><div class="craft-flow-item"><span class="craft-flow-num">3</span><span>We Deliver Hot &amp; Fresh</span></div></div><div class="craft-perks"><span><span class="craft-perk-icon">✓</span>20+ Guests</span><span><span class="craft-perk-icon">✓</span>Live Pricing</span><span><span class="craft-perk-icon">✓</span>Free Delivery*</span><span><span class="craft-perk-icon">✓</span>Custom Combos</span></div><a href="craft-my-plate.html" class="btn btn--primary btn--lg craft-hero-btn">'+D.craftPreview.buttonText+' →</a></div></div></div></section>';
