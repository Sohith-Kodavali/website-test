...
function renderIndex(D) {
  ...
  document.getElementById('render-craft-preview').innerHTML = '<section class="section craft-section"><div class="container"><div class="section__head reveal"><span class="eyebrow">'+D.craftPreview.eyebrow+'</span><h2>'+D.craftPreview.headline+'</h2><p class="muted">'+D.craftPreview.desc+'</p></div><div class="craft-steps reveal"><div class="craft-step-card reveal delay-1"><div class="craft-step-icon">📋</div><h4>Pick Your Menu</h4><p>Choose from starters, mains, biryani &amp; desserts</p></div><div class="craft-step-connector"><span>→</span></div><div class="craft-step-card reveal delay-2"><div class="craft-step-icon">👥</div><h4>Set Your Guests</h4><p>From 10 to 500 guests · live pricing updates</p></div><div class="craft-step-connector"><span>→</span></div><div class="craft-step-card reveal delay-3"><div class="craft-step-icon">🎉</div><h4>Enjoy The Feast</h4><p>We deliver fresh · on time · every time</p></div></div><div class="craft-highlights reveal delay-4"><div class="craft-highlight"><span class="craft-highlight-check">✓</span><span>20+ Guests</span></div><div class="craft-highlight"><span class="craft-highlight-check">✓</span><span>Live Pricing</span></div><div class="craft-highlight"><span class="craft-highlight-check">✓</span><span>Free Delivery*</span></div><div class="craft-highlight"><span class="craft-highlight-check">✓</span><span>Custom Combos</span></div></div><div class="craft-cta-wrap reveal delay-4"><div class="craft-price-pill">Starting at <strong>₹250</strong> /person</div><a href="craft-my-plate.html" class="btn btn--primary btn--lg craft-cta-btn">'+D.craftPreview.buttonText+'</a></div></div></section>';
